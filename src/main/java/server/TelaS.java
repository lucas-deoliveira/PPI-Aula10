...
public class TelaS {
    ...
    public void init() {
        ...
        JLabel label_listaUsuario = new JLabel("Lista de Usuarios");
    ...
    public void myEvent() {
        window.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                if (Servidor.listaUsuario != null && Servidor.listaUsuario.size() != 0) {
                    try {
                        new SEnvia(Servidor.listaUsuario, "", "5", "");
        ...
        enviar.addActionListener(e -> enviarMsg());
    }
    ...
    public void enviarMsg() {
        ...
        if ("".equals(messages)) {
            ...
            try {
                new SEnvia(Servidor.listaUsuario, getnomeServidor() + ": " + messages, "1", "");
